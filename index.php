...
<div id="wrapper"> 
  ...
  <header id="header">
    ...
    <section class="logo-row">
      <div class="container"> <strong class="logo"><a href="index-2.html"><img src="images/logo.png" alt="logo"></a></strong>
          ...
          <div class="col-md-6 col-sm-6">
            <div class="event-box">
              ...
              <div class="text-box">
                ...
                <a href="bnmit/bnmit.html" class="btn-read-row">Gallery</a> </div>
            </div>
          </div>
        </div>
 ...
 <section class="topbar">
      <div class="container">
        <div class="left-box">
          <ul>
            <li><img src="images/map-icon.png" alt="img"><a href="https://www.google.com/maps/place/944,+16th+Cross+Rd,+1st+Stage,+Kumaraswamy+Layout,+Bengaluru,+Karnataka+560078/@12.907903,77.561819,17z/data=!4m5!3m4!1s0x3bae3fd80a58ef61:0xda2ad8d9bdec7671!8m2!3d12.9079031!4d77.5618188?hl=en-US" target="blank"> Kumarswamy Layout,Bangalore,India</a> </li>
            <li><img src="images/envlope-icon.png" alt="img"><a href="#">info@ssttech.in</a></li>
            <li><img src="images/phone-icon.png" alt="img">+(91)-9591091444 | +(91)-8147066971</li>
          </ul>
        </div>
    ...
    <section class="footer-section-3">
      <div class="container"> <strong class="copyrights">SST Technologies &copy; 2022 / ALL RIGHTS RESERVED</strong>
